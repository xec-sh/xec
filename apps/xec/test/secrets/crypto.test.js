...
import { encode, decode, encrypt, decrypt, hashKey, deriveKey, secureCompare, generateSecret, createFingerprint } from '../../src/secrets/crypto.js';
describe('Crypto Module', () => {
    const testMachineId = 'test-machine-id-12345';
    const testPassphrase = 'test-passphrase';
    const testValue = 'my-secret-value';
    const testRealFileEncryption = async (filePath, content) => {
    ...
    describe('generateSecret', () => {
        ...
        it('should handle edge cases', () => {
            ...
            expect(() => generateSecret(1025)).toThrow();
        });
    });
    ...
    describe('real file encryption', () => {
        it('should encrypt and decrypt files correctly', async () => {
            ...
            expect(fileSize).toBeGreaterThan(content.length);
        });
