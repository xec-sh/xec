...
describe('SecretManager', () => {
    ...
    describe('initialization', () => {
        ...
        it('should handle initialization errors', async () => {
            ...
            manager = new SecretManager();
            manager.provider = errorProvider;
    ...
    describe('validation', () => {
        ...
        it('should enforce value length limits', async () => {
            ...
            const tooLargeValue = 'x'.repeat(65 * 1024);
    ...
    describe('provider types', () => {
        it('should throw for unimplemented providers', () => {
            ...
            for (const type of unimplementedTypes) {
                expect(() => new SecretManager({ type: type })).toThrow(SecretError);
                try {
                    new SecretManager({ type: type });
                }
                catch (error) {
                    expect(error).toBeInstanceOf(SecretError);
        ...
        it('should validate value type', async () => {
            manager = new SecretManager();
            manager.provider = mockProvider;
            await expect(manager.set('key', 123)).rejects.toThrow(SecretError);
            try {
