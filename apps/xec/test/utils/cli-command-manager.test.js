...
import { findCommand, CliCommandManager, loadDynamicCommands, registerCliCommands, getCliCommandManager, buildCommandRegistry, discoverAndLoadCommands } from '../../src/utils/cli-command-manager.js';
...
describe('CliCommandManager', () => {
    ...
    beforeAll(() => {
        ...
        globalThis.__xecModuleContext = {
            import: jest.fn().mockImplementation((module) => {
                if (module === 'chalk') {
    ...
    afterAll(() => {
        delete process.env['XEC_DEBUG'];
        delete globalThis.__xecModuleContext;
    });
    beforeEach(() => {
    ...
    describe('exported functions', () => {
        ...
        describe('findCommand', () => {
            ...
            it('should return null for invalid inputs', () => {
                expect(findCommand(null, 'test')).toBeNull();
    ...
    describe('module context integration', () => {
        it('should have access to global module context', async () => {
            ...
            const consoleErrorSpy = jest.spyOn(console, 'error').mockImplementation();
            await manager.discoverAndLoad(program);
            expect(globalThis.__xecModuleContext).toBeDefined();
            consoleErrorSpy.mockRestore();
        });
    });
});
//# sourceMappingURL=cli-command-manager.test.js.map