...
import { sleep, withTimeout, parseTimeout, parseInterval, formatDuration, getNextRunTime, retryWithBackoff, createTimeoutPromise } from '../../src/utils/time.js';
describe('time utils', () => {
    ...
    describe('getNextRunTime', () => {
        it('should calculate next run time for interval type', () => {
            ...
            const interval = { type: 'interval', value: 300000 };
        ...
        it('should use current time when from is not provided', () => {
            const interval = { type: 'interval', value: 60000 };
        ...
        it('should throw for cron expressions (not implemented)', () => {
            const interval = { type: 'cron', value: '0 0 * * *' };
    ...
    describe('withTimeout', () => {
        ...
        it('should reject if function takes too long', async () => {
            const fn = jest.fn().mockImplementation(() => new Promise(resolve => setTimeout(() => resolve('too late'), 2000)));
