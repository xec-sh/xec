...
import { RGBA, Renderer, BoxComponent, TextComponent, createRenderer, FrameBufferComponent } from "../src/index"
...
export function run(rendererInstance: Renderer): void {
  ...
  buffer = new FrameBufferComponent(renderer.root.ctx, {
    id: "ascii-demo",
  ...
  const scrollInstructions = new TextComponent(renderer.root.ctx, {
