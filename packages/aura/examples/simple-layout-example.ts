...
function createLayoutElements(rendererInstance: Renderer): void {
  ...
  header = new BoxComponent("header", {
    zIndex: 0,
    width: "auto",
    height: 3,
  ...
  contentArea = new GroupComponent("content-area", {
    zIndex: 0,
    width: "auto",
    height: "auto",
    flexDirection: "row",
  ...
  sidebar = new BoxComponent("sidebar", {
    zIndex: 0,
    width: "auto",
    height: "auto",
  ...
  mainContent = new BoxComponent("main-content", {
    zIndex: 0,
    width: "auto",
    height: "auto",
  ...
  rightSidebar = new BoxComponent("right-sidebar", {
    zIndex: 0,
    width: "auto",
    height: "auto",
  ...
  footer = new BoxComponent("footer", {
    zIndex: 0,
    width: "auto",
    height: 3,
  ...
  moveableElement = new BoxComponent("moveable", {
    zIndex: 100,
    width: 8,
    height: 3,
