...
export function run(renderer: CliRenderer): void {
  ...
  parentContainer = new GroupComponent("framebuffer-container", {
    zIndex: 10,
    visible: true,
  })
  renderer.root.add(parentContainer)

  const titleText = new TextComponent("framebuffer_title", {
  ...
  const subtitleText = new TextComponent("framebuffer_subtitle", {
  ...
  const instructionsText = new TextComponent("framebuffer_instructions", {
  ...
  const patternBufferRenderable = new FrameBufferComponent("pattern", {
  ...
  const boxObj = new FrameBufferComponent("moving-box", {
    width: 20,
    height: 10,
    position: "absolute",
    left: 10,
  ...
  const overlayBufferRenderable = new FrameBufferComponent("overlay", {
    width: 40,
    height: 15,
    position: "absolute",
    left: 30,
  ...
  const ballObj = new FrameBufferComponent("ball", {
    width: 3,
    height: 3,
    position: "absolute",
    left: 20,
  ...
  const resizableObj = new FrameBufferComponent("resizable-box", {
    width: 10,
    height: 5,
    position: "absolute",
    left: 50,
  ...
  const sourceObj = new FrameBufferComponent("large-source", {
    width: 40,
    height: 20,
    position: "absolute",
    zIndex: -1,
  ...
  const cropBuffer1Renderable = new FrameBufferComponent("crop-demo-1", {
    width: 12,
    height: 8,
    position: "absolute",
    left: 5,
  ...
  const cropBuffer2Renderable = new FrameBufferComponent("crop-demo-2", {
    width: 15,
    height: 6,
    position: "absolute",
    left: 25,
  ...
  const cropBuffer3Renderable = new FrameBufferComponent("crop-demo-3", {
    width: 10,
    height: 10,
    position: "absolute",
    left: 45,
  ...
  const cropDemoLabel = new TextComponent("crop_demo_label", {
  ...
  const debugInstructionsText = new TextComponent("framebuffer_debug_instructions", {
