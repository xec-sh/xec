...
export function run(renderer: CliRenderer): void {
  ...
  const parentGroupA = new GroupComponent("parent-group-a", {
    position: "absolute",
    zIndex: 100,
    visible: true,
  })
  ...
  const parentGroupB = new GroupComponent("parent-group-b", {
    position: "absolute",
    zIndex: 50,
    visible: true,
  })
  ...
  const parentGroupC = new GroupComponent("parent-group-c", {
    position: "absolute",
    zIndex: 20,
    visible: true,
  })
  ...
  const boxA1 = new BoxComponent("box-a1", {
    position: "absolute",
    left: 15,
    top: 8,
    width: 25,
  ...
  const textA1 = new TextComponent("text-a1", {
  ...
  const boxA2 = new BoxComponent("box-a2", {
    position: "absolute",
    left: 20,
    top: 11,
    width: 15,
  ...
  const textA2 = new TextComponent("text-a2", {
  ...
  const boxB1 = new BoxComponent("box-b1", {
    position: "absolute",
    left: 30,
    top: 12,
    width: 25,
  ...
  const textB1 = new TextComponent("text-b1", {
  ...
  const boxB2 = new BoxComponent("box-b2", {
    position: "absolute",
    left: 35,
    top: 15,
    width: 15,
  ...
  const textB2 = new TextComponent("text-b2", {
  ...
  const boxC1 = new BoxComponent("box-c1", {
    position: "absolute",
    left: 45,
    top: 16,
    width: 25,
  ...
  const textC1 = new TextComponent("text-c1", {
  ...
  const boxC2 = new BoxComponent("box-c2", {
    position: "absolute",
    left: 50,
    top: 19,
    width: 15,
  ...
  const textC2 = new TextComponent("text-c2", {
  ...
  const phaseIndicator = new TextComponent("phase-indicator", {
  ...
  const zIndexDisplay = new TextComponent("zindex-display", {
