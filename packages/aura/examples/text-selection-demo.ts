...
let leftGroup: BoxComponent | null = null
let rightGroup: BoxComponent | null = null
...
export function run(renderer: Renderer): void {
  ...
  leftGroup = new BoxComponent(renderer.root.ctx, {
    id: "leftGroup",
    position: "absolute",
    left: 2,
    top: 2,
  ...
  const text1 = new TextComponent(renderer.root.ctx, {
    id: "text1",
  ...
  const text2 = new TextComponent(renderer.root.ctx, {
    id: "text2",
  ...
  const text3 = new TextComponent(renderer.root.ctx, {
    id: "text3",
  ...
  const nestedBox = new BoxComponent(renderer.root.ctx, {
    id: "nestedBox",
    left: 2,
    top: 1,
    width: 31,
  ...
  const nestedText = new TextComponent(renderer.root.ctx, {
    id: "nestedText",
  ...
  rightGroup = new BoxComponent(renderer.root.ctx, {
    id: "rightGroup",
    position: "absolute",
    left: 48,
    top: 2,
  ...
  const codeText1 = new TextComponent(renderer.root.ctx, {
    id: "codeText1",
  ...
  const codeText2 = new TextComponent(renderer.root.ctx, {
    id: "codeText2",
  ...
  const codeText3 = new TextComponent(renderer.root.ctx, {
    id: "codeText3",
  ...
  const codeText4 = new TextComponent(renderer.root.ctx, {
    id: "codeText4",
    content: "}",
    zIndex: 21,
    fg: "#e6edf3",
  ...
  floatingBox = new BoxComponent(renderer.root.ctx, {
    id: "floatingBox",
    position: "absolute",
    left: 90,
    top: 11,
  ...
  const multilineText = new TextComponent(renderer.root.ctx, {
    id: "multilineText",
