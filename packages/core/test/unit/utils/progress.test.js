...
describe('ProgressReporter', () => {
    ...
    describe('Output reporting', () => {
        ...
        test('should track byte count', () => {
            ...
            reporter.complete();
            const completeCall = onProgress.mock.calls.find(call => call[0].type === 'complete');
            expect(completeCall?.[0]?.data).toEqual({
                linesProcessed: 0,
                bytesProcessed: 11
            });
        });
    ...
    describe('Formatting utilities', () => {
        test('should format bytes correctly', () => {
            const reporter = new ProgressReporter();
            const formatBytes = reporter.formatBytes.bind(reporter);
        ...
        test('should format duration correctly', () => {
            const reporter = new ProgressReporter();
            const formatDuration = reporter.formatDuration.bind(reporter);
        ...
        test('should create progress bar correctly', () => {
            const reporter = new ProgressReporter();
            const createProgressBar = reporter.createProgressBar.bind(reporter);
    ...
    describe('Edge cases', () => {
        ...
        test('should handle zero duration', () => {
            ...
            reporter.start();
            reporter.progress('Processing', 50, 100);
            const progressCall = onProgress.mock.calls.find(call => call[0].type === 'progress')?.[0];
