...
describe('SecurePasswordHandler - Comprehensive Coverage', () => {
    ...
    describe('Askpass Script Creation', () => {
        ...
        it('should set correct permissions on script', async () => {
            ...
            const { mode } = await import('fs').then(fs => new Promise((resolve, reject) => fs.stat(scriptPath, (err, stats) => err ? reject(err) : resolve(stats))));
...
//# sourceMappingURL=secure-password-coverage.test.js.map