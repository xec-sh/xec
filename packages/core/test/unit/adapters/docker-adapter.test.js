...
let testContainers = [];
async function execDocker(args) {
...
async function ensureTestContainer(containerName) {
...
describe('DockerAdapter Enhanced Tests', () => {
    ...
    describe('Auto-create container functionality', () => {
        let autoCreateAdapter;
        let autoContainerName;
        beforeEach(() => {
    ...
    describe('Large output handling', () => {
        ...
        it('should handle large stdout output', async () => {
            ...
            expect(result.exitCode).toBe(0);
            expect(result.stdout.length).toBeGreaterThan(70000);
        });
        it('should handle large stderr output', async () => {
            ...
            expect(result.exitCode).toBe(0);
            expect(result.stderr.length).toBeGreaterThan(10000);
