...
describe('SSHAdapter - Secure Password Integration', () => {
    let adapter;
    let mockSecureHandler;
    beforeEach(() => {
        jest.clearAllMocks();
        mockSecureHandler = {
            createAskPassScript: jest.fn().mockResolvedValue('/tmp/askpass-mock.sh'),
            cleanup: jest.fn().mockResolvedValue(undefined),
            createSecureEnv: jest.fn().mockReturnValue({
    ...
    describe('Sudo Configuration', () => {
        it('should create adapter with sudo disabled by default', () => {
            ...
            const sudoConfig = adapter.sshConfig.sudo;
        ...
        it('should support all sudo methods', () => {
            ...
            methods.forEach(method => {
                ...
                const sudoConfig = testAdapter.sshConfig.sudo;
    ...
    describe('Integration with Base Adapter', () => {
        it('should inherit base adapter configuration', () => {
            ...
            const baseConfig = adapter.config;
    ...
    describe('Configuration Edge Cases', () => {
        ...
        it('should handle all configuration options together', () => {
            ...
            const sshConfig = adapter.sshConfig;
...
//# sourceMappingURL=ssh-adapter-secure-password.test.js.map