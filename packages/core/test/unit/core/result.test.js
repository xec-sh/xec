...
describe('ExecutionResult', () => {
    describe('ExecutionResultImpl', () => {
        it('should create with all properties', () => {
            ...
            const result = new ExecutionResultImpl('output text', 'error text', 0, 'SIGTERM', 'echo test', 1000, startedAt, finishedAt, 'local', 'example.com', 'my-container');
    ...
    describe('toMetadata()', () => {
        it('should serialize all properties', () => {
            const startedAt = new Date('2024-01-01T00:00:00Z');
            const finishedAt = new Date('2024-01-01T00:00:01Z');
            const result = new ExecutionResultImpl('output', 'error', 1, 'SIGKILL', 'test command', 1000, startedAt, finishedAt, 'ssh', 'server.com', undefined);
    ...
    describe('json<T>()', () => {
        ...
        it('should parse number', () => {
            ...
            expect(result.json()).toBe(123.45);
        });
        ...
        it('should handle JSON with whitespace', () => {
            ...
            expect(result.json()).toEqual({ test: true });
        });
