...
import { memo, watch, derived, computed, watchMany, asyncComputed, computedValues } from '../../../../src/core/reactive/computed.js';
describe('Computed Values', () => {
    ...
    describe('computed', () => {
        it('should create basic computed value', () => {
            const fullName = computed(state, get => `${get('firstName')} ${get('lastName')}`);
    ...
    describe('asyncComputed', () => {
        it('should handle async computations', async () => {
            const asyncData = asyncComputed(state, async (get) => {
    ...
    describe('complex scenarios', () => {
        it('should handle computed chains', () => {
            ...
            const info = computed(state, get => `Age: ${get('age')}, Doubled: ${doubled()}, Quadrupled: ${quadrupled()}`);
