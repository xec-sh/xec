...
import { AutocompletePrompt } from '../../../../src/components/advanced/autocomplete.js';
describe('AutocompletePrompt', () => {
    describe('rendering', () => {
        it('should render the message and placeholder', async () => {
            await testPrompt(AutocompletePrompt, {
    ...
    describe('input handling', () => {
        it('should handle text input', async () => {
            const result = await testPrompt(AutocompletePrompt, {
                message: 'Search',
    ...
    describe('async source', () => {
        it('should load suggestions from async source', async () => {
            const source = vi.fn(async (input) => {
                await new Promise(resolve => setTimeout(resolve, 50));
                return [
    ...
    describe('non-TTY mode', () => {
        it('should handle non-TTY environment', async () => {
            const result = await testNonTTYPrompt(AutocompletePrompt, {
