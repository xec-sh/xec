...
export function createMockTTY(isTTY = true) {
...
export function createMockReadStream(isTTY = true) {
    const stream = createMockTTY(isTTY);
...
export function mockProcessStreams(options = {}) {
...
//# sourceMappingURL=mock-tty.js.map