...
async function main() {
	...
	const products: Product[] = [
		{ sku: 'LAPTOP-001', name: 'Pro Laptop', price: 1299, category: { id: 1, name: 'Electronics' } },
		...
		{ sku: 'MOUSE-004', name: 'Wireless Mouse', price: 29, category: { id: 1, name: 'Electronics' } },
		{ sku: 'COURSE-005', name: 'Node.js Course', price: 199, category: { id: 3, name: 'Education' } },
	];
